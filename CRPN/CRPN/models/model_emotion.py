...
class Encoder(nn.Module):
    ...
    def __init__(self):
        ...
        weight_path = os.path.join(current_dir, "..", "backbone_weight", "resnet50_ft_weight.pkl")
        weight_path = os.path.abspath(weight_path)
        model = resnet50()
        load_state_dict(model, weight_path)  # pre-trained model for face identification
...
class Encoder_18(nn.Module):
    ...
    def __init__(self):
        ...
        current_dir = os.path.dirname(os.path.abspath(__file__))
        weight_path = os.path.join(current_dir, "..", "backbone_weight", "resnet18_msceleb.pth")
        weight_path = os.path.abspath(weight_path)
